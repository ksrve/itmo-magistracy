...
public interface CommandExecutor {
    ...
    /**
     * Executes the command using the specified {@link EmployeeServiceImpl}.
     *
     * @param employeeService the {@link EmployeeServiceImpl} to be used for executing the command
     */
    void run(EmployeeServiceImpl employeeService);
