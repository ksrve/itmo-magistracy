...
public class DeleteCommandExecutor implements CommandExecutor {
     ...
     * {@link EmployeeApiClient}. It retrieves the employee service implementation
     ...
     * </p>
     *
     * @param service the {@link EmployeeApiClient} instance used to communicate
    ...
    public void run(EmployeeApiClient service) {
        try {
            service.getApi().delete(args.getId());
