...
public class Args {
    ...
    /**
     * The standalone parameter, which, when set,
     * will use standalone app uri. Defaults to false.
     */
    @Parameter(
            names = "--standalone",
    ...
    @Parameter(
            names = "--username",
            description = "Username to auth requests",
            required = true)
    private String username;

    @Parameter(
            names = "--password",
            description = "Password to auth requests",
            required = true)
